...
public class IgniteKernal implements IgniteEx, IgniteMXBean, Externalizable {
    ...
    @Override public IgniteClusterEx cluster() {
        return ctx.cluster().clusterInstance();
    }

    /** {@inheritDoc} */
    @Override public ClusterNode localNode() {
        return ctx.cluster().clusterInstance().localNode();
    }

    /** {@inheritDoc} */
    @Override public IgniteCompute compute() {
        return ctx.cluster().clusterInstance().compute();
    }

    /** {@inheritDoc} */
    @Override public IgniteMessaging message() {
        return ctx.cluster().clusterInstance().message();
    }

    /** {@inheritDoc} */
    @Override public IgniteEvents events() {
        return ctx.cluster().clusterInstance().events();
    }

    /** {@inheritDoc} */
    @Override public IgniteServices services() {
        return ctx.cluster().clusterInstance().services();
    }

    /** {@inheritDoc} */
    @Override public ExecutorService executorService() {
        return ctx.cluster().clusterInstance().executorService();
    }
    ...
    private void stop0(boolean cancel) {
        ...
        if (stopGuard.compareAndSet(false, true)) {
            ...
            try {
                ...
                ctx.cluster().clusterInstance().clearNodeMap();
